...
- Used for quick code review support during refactoring (readability and consistency checks).
- Used to improve visual hierarchy and small UI/UX refinements.
...
- GitHub Copilot: used in this assignment for code completion, generation, and debugging help.
- ChatGPT / Claude: used in this assignment for explanations and documentation planning.
- Cursor / Replit: not used directly in this assignment, but reviewed as possible alternatives.
---
...
- Sometimes tool suggestions were correct conceptually but needed adjustment to fit my naming/style conventions.
...
- Better understanding of when to accept AI suggestions and when to reject/simplify them.
...
5. I kept only changes I could explain and justify in my own words.
